<%-- Document : purchaseOrder Created on : May 27, 2023, 11:49:48 PM Author : ASUS PC --%>
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light position-fixed fixed-top"
                    ...
                    <div class="container">
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <div class="navbar-nav mr-auto">
                                ...
                                <a class="navbar-brand" href="#">
                                    <div style="display: flex;">
                                        <img src="https://png.pngtree.com/element_our/png/20180917/food-logo-design.-knife-fork-and-spoon-logo.-png_98037.jpg"
                                            width="40px" height="40px" class="d-inline-block align-top" alt="">
                            ...
                            <div>
                                <a href="cart">
                                    <svg width="30px" height="30px" viewBox="0 0 96 96"
                                            ...
                                            <g id="pills" transform="translate(0 -116)">
                                                <g id="Group_154" data-name="Group 154">
                                                    <path id="Path_188" data-name="Path 188"
                                                        ...
                                                        fill="none" stroke="#58595b" stroke-linecap="round"
                                                        stroke-linejoin="round" stroke-width="4" />
                                                    <circle id="Ellipse_335" data-name="Ellipse 335" cx="4.5" cy="4.5"
                                                        r="4.5" transform="translate(20 187)" fill="none"
                                                        stroke="#58595b" stroke-linecap="round" stroke-linejoin="round"
                                                        stroke-width="4" />
                                                    <circle id="Ellipse_336" data-name="Ellipse 336" cx="4.5" cy="4.5"
                                                        r="4.5" transform="translate(49 187)" fill="none"
                                                        stroke="#58595b" stroke-linecap="round" stroke-linejoin="round"
                                                        stroke-width="4" />
                                                </g>
                                            </g>
                                    ...
                                    <span class='badge badge-warning' id='lblCartCount'
                                        style="background-color: #ec3443; border-radius: 9px; padding: 1px 4px;">${data.size()}</span>
                                </a>
                                <c:if test="${sessionScope.role == null}">
                                    <!-- <button href="login"> -->
                                    <button type="button" id="btnlogin" class="btn btn-primary" data-toggle="modal"
                                        data-target="#exampleModalCenter"
                                        style="background-color: #f8f9fa; padding: 6px; border: 0px;">
                                ...
                                <div class="col-md-4 order-md-2 mb-4">
                                    <h4 class="d-flex justify-content-between align-items-center mb-3">
                                        ...
                                        <span class="badge badge-secondary badge-pill"
                                            style="background-color: #ff5b6a;">${data.size()}</span>
                                    </h4>
                                        ...
                                        <c:forEach items="${data}" var="item">
                                            ...
                                            <li class="list-group-item d-flex justify-content-between lh-condensed">
                                                <div>
                                                    ...
                                                    <small class="text-muted">${item.price}.000 ₫ x
                                                        ${item.quantity}</small>
                                                </div>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            <button type="submit" class="btn btn-secondary"
                                                style="background-color: #ff5b6a;">Xác nhận</button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" class="form-control" name="email" id="kh_email"
                                                style="background-color: white;" value="${user.email}" readonly>
                                        </div>
                                    </div>
                ...
                <footer class="footer "
                    ...
                    <div class="container" style="padding: 35px; display: block; max-width: fit-content;">
                        <div class="w3-third" style="width: inherit;">
                            ...
                            <h6 style="text-align: center;">Đặc biệt hơn, NMD-Shop giao hàng MIỄN PHÍ khi bạn đặt hàng
                                qua Website NMD-Shop hoặc gọi đến số 1900.1111.</h6>
                        </div>
                    </div>
                    <div class="copyright" style="background-color: #FF9EA2; padding:0px; text-align: center; ">
                        <h6 style="margin-top: 15px; color: white;">© 2023 NMD-Shop All Rights Reserved Site by LDCC
                        </h6>
