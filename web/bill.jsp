...
<html>
    <head>
        ...
        <link
            rel="stylesheet"
            type="text/css"
            href="${pageContext.request.contextPath}/styles/bill.css"
            />
        <style>
            html {
                /* zoom: 0.9; */
    ...
    <body style="background-color: #FFEAE3; margin-top: 70px; ">
        ...
        <div class="row" style="width: 60%; height: auto; margin: 0 auto; ">
            <!-- menu -->
            <div class="col-md-auto menu" style="padding: 20px 30px;">
                <h5>Account</h5>
            ...
            <div class="col-md-9 ">
                <!-- Shopping invoice table -->
                <div class="card content-product">
                    <div class="card-header" style="background-color: #FF9EA2;">
                        <h2 style="font-family: 'Poppins'; font-weight: revert; color: white; text-align: center;">Your Orders</h2>
                    </div>
                    <div class="orderlist" style="padding: 15px 20px;">
                        ...
                        <c:forEach items="${data}" var="bill" varStatus="loopStatus">
                            ...
                            <c:forEach items="${bill}" var="products" varStatus="innerLoopStatus">
                                    ...
                                    <div class="col-md-3 second-product" style="padding: 0;">
                                        <div class="text">
                                            ...
                                            <div style="margin-top: 28px;">
                                                <p >total:</p> <p class="right">${products.price * products.quantity}.000 ₫ </p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <c:if test="${innerLoopStatus.last}">
                                    ...
                                    <div class="row" style="margin-top: 10px; margin-bottom: 10px;">
                                        ...
                                        <div class="col-md-4 second-product" style="padding: 0;">
                                            <div class="text">

                                                <div>
                                                    <p style=>Total:</p> <p class="right">${bill.getTotalPrice()}.000 ₫</p><br>
                                                </div>
                            ...
                            <c:if test="${!loopStatus.last}">
                                <div style="background-color: rgb(148, 148, 148); margin-top: 20px; margin-bottom: 20px; padding: 0.3px 0px;"></div>
                            </c:if>
                        </c:forEach>
